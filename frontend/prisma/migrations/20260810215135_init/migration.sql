-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'DENTIST', 'STAFF', 'PATIENT');
...
-- AddForeignKey
ALTER TABLE "Transcription" ADD CONSTRAINT "Transcription_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "Patient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
